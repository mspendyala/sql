...
GRANT USAGE ON SCHEMA dbname TO abcd1234;
GRANT SELECT ON ALL TABLES IN SCHEMA dbname TO abcd1234;
ALTER DEFAULT PRIVILEGES IN SCHEMA dbname GRANT SELECT ON TABLES TO abcd1234;
-------
